...
- for degree modifiers on adjectives or adverbs (e.g. "very tall", "extremely fast", "slightly warm", "barely visible"), encode the graded degree via the STV strength of the base predicate rather than creating a separate predicate for each degree: e.g. "Alice is very tall" → `(: alice_very_tall (HasAttribute alice_1 tall) (STV 0.95 0.9))`, "the water is slightly warm" → `(: water_slightly_warm (HasAttribute water_1 warm) (STV 0.6 0.9))`, "it is barely visible" → `(: thing_barely_visible (HasAttribute thing_1 visible) (STV 0.15 0.9))`; a rough mapping is: "extremely/very" ≈ 0.9–1.0, "quite/fairly" ≈ 0.7–0.8, "somewhat/slightly" ≈ 0.5–0.65, "barely/hardly" ≈ 0.1–0.3
